package com.divot.epicfightqol.mixins.parcool.common.event;
...
import com.divot.epicfightqol.EpicStamina.EpicFightManager;
...
@Mixin(EventAttachCapability.class)
class MixinEventAttachCapability {
    ...
    public static void onAttachCapability(AttachCapabilitiesEvent<Entity> event) {
        ...
        //Stamina
        {
            ...
            if (player.isLocalPlayer() && Common.COMMON.getEpicStamina()) {
                //EpicFightQOL.LOGGER.info("staminaed");
                instance = EpicFightManager.newEpicStaminaFor(player);
            }
